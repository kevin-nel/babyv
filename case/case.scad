S// this uses modified versions of the svgs and features a curved top and screw holes as well as a slot for pro micro.
// plainoldcheese 2021
...
module plate(){
    union(){
        difference(){
            ...
            // extra room for stabilisers to clip
...
module bottom(){
    //bottom plate with holes for screws
    difference(){
